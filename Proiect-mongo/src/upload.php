...
<html>
	<head>
		<title>Upload Score - Game Leaderboards</title>
		<meta charset="utf-8" />
		...
		<!-- Wrapper -->
			<div id="wrapper">
				...
				<!-- Main -->
					<div id="main">
						<div class="inner">
							<h1>Upload Your Score</h1>
							<p>Share your achievement with the community! Upload a screenshot of your completion time and your score.</p>
							...
							?>
								<div style="background-color: #f8d7da; color: #721c24; padding: 15px; border-radius: 4px; margin-bottom: 20px;">
									<p>You need to be logged in to upload scores. <a href="login.php">Click here to login</a></p>
								</div>
							<?php
							else:
							?>
								<form method="post" action="save.php" enctype="multipart/form-data">
									<div class="row gtr-uniform">
										<!-- Image Upload -->
										<div class="col-12">
											<label for="imagine">Screenshot Image:</label>
											<input type="file" name="imagine" id="imagine" accept="image/*" required />
										</div>
										
										<!-- Score Input -->
										<div class="col-12">
											<label for="scor">Your Score/Time:</label>
											<input type="text" name="scor" id="scor" required />
										</div>
										...
										<div class="col-12">
											<ul class="actions">
												<li><input type="submit" name="upload" value="Upload Score" class="primary" /></li>
